    ...
    <section class="bio">
      <div class="container" style="margin-top: 50px">
        <div class="row">
          ...
          <div class="col-4">
            <h1><a href="gambar/g{{ $p }}.gif"><img src="gambar/g{{ $p }}.gif" alt="" width="80%" class="rounded-circle img-thumbnail" style="margin-left: 60px"></a></h1>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container" style="margin-top: 10px">
        <div class="row">
          <div class="col-2 border border-primary border-3 rounded-3">
            <a href="https://www.facebook.com/fahtlamyth.myth/">
              <div class="row">
          ...
          <div class="col-2 border border-danger border-3 rounded-3">
            <a href="https://www.instagram.com/althaf.notfound/">
              <div class="row">
          ...
          <div class="col-2 border border-info border-3 rounded-3">
            <a href="https://twitter.com/AndiAlthaf_KZM">
              <div class="row">
