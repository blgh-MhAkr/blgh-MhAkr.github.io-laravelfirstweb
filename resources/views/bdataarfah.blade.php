          ...
          <div class="col">
            ...
            <h4>
              <div class="row align-items-center" style="background-color: white">
                ...
                <div class="col">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores nobis molestiae nihil numquam ratione debitis labore vel esse dignissimos distinctio cupiditate veritatis ea, omnis beatae iusto porro voluptates vitae doloremque reprehenderit consequuntur, animi neque sunt! Doloremque modi optio consequatur quae.
                </div>
              </div>
            </h4>
          </div>
      ...
      <div class="container" style="margin-top: 10px">
        <div class="row">
          ...
          <div class="col-2 border border-danger border-3 rounded-3">
            <a href="https://instagram.com/taddaarfah?utm_medium=copy_link">
              <div class="row">
