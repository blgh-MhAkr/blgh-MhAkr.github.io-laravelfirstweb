          ...
          <div class="col">
            ...
            <h4>
              <div class="row align-items-center" style="background-color: white">
                ...
                <div class="col">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum distinctio, labore quidem illo quibusdam officiis perspiciatis earum culpa pariatur maxime suscipit, soluta est ad? Obcaecati doloremque quas aut? Inventore amet et deleniti esse autem ipsum laboriosam, dolores doloribus voluptates temporibus?
                </div>
              </div>
            </h4>
          </div>
      ...
      <div class="container" style="margin-top: 10px">
        <div class="row">
          <div class="col-2 border border-primary border-3 rounded-3">
            <a href="https://free.facebook.com/?refsrc=deprecated&_rdc=1&_rdr">
              <div class="row">
          ...
          <div class="col-2 border border-danger border-3 rounded-3">
            <a href="https://www.instagram.com/devii.dh/">
              <div class="row">
