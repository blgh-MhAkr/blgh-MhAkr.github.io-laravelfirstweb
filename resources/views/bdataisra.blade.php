          ...
          <div class="col">
            ...
            <h4>
              <div class="row align-items-center" style="background-color: white">
                ...
                <div class="col">
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit. Itaque doloribus quia eveniet atque voluptate modi quod porro ipsa voluptas exercitationem assumenda nemo saepe facere minus ab fugit expedita, minima dicta, dolorum eligendi? Natus sunt alias deleniti doloremque voluptate repudiandae dicta!
                </div>
              </div>
            </h4>
          </div>
      ...
      <div class="container" style="margin-top: 10px">
        <div class="row">
          ...
          <div class="col-2 border border-danger border-3 rounded-3">
            <a href="https://www.instagram.com/muh.alisra/">
              <div class="row">
